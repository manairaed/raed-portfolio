window.works = [
  {
    id: 1,
    title : "COMAR SYNC",
    titleSection: "Insurance Data Automation Platform",
    date: "Feb 2025 - Jul 2025",
    company: "Comar Assurances",
    overview:
      "A final-year engineering project developed for COMAR Assurances to automate data exchange workflows between systems and external partners.",
    problem:
  ...
  },
  {
    id: 2,
    title: "OCEANA PADEL",
    titleSection: "Mobile Booking & Admin Dashboard",
    date: "Nov 2024 – Jan 2025",
    company: "Freelance Project | Hotel Oceana",
    overview:
      "A full system for managing padel court reservations via a Flutter mobile app, Node.js backend, and Angular dashboard.",
    problem:
  ...
  },
  {
    id: 3,
    title: "BasketFollow",
    titleSection: "Sports Association Management App",
    date: "Feb 2022 – Aug 2022",
    company: "Neopolis Development",
    overview:
      "A digital management platform for the French Basketball Federation (FFBB).",
    problem:
  ...
  {
    id: 4,
    title: "MAAAR – Cryptocurrency Wallet Platform",
    titleSection: "Cryptocurrency Wallet Platform",
    date: "Mar 2025 – Jun 2025",
    company: "Freelance Project | MAAAR",
    overview:
      "A web-based cryptocurrency wallet dashboard with secure API integration.",
    problem:
      "Users needed a unified and safe interface to monitor and manage their digital assets.",
    solution:
      "Built a responsive Vue.js and Laravel platform integrating secure API communication for wallet management and transaction insights.",
